        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/selamatdatang.png" width="300" class="img img-responsive" height="300"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang Admin SD Negeri 10 Semayang</strong>
