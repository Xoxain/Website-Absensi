...
<head>
  ...
  <title>Sistem Informasi Guru - Home</title>
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/dinaspendidikan.png" alt="">
            </div>
          </div>
          <div class="col-lg-9 pt-5">
            <div class="hero-banner__content">
              <h1>Website Absensi Guru SD Negeri 10 Semayang</h1>
              <p>Website ini berfungsi sebagai absensi Guru SD Negeri 10 Semayang dan sebagai sistem informasi karyawan.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">SD Negeri 10 Semayang </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
    ...
    <section class="section-margin">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <ul class="list-inline" id="chart-skill">
          ...
          <li><a href="karyawan/login_karyawan.php" target="_blank"><button class="btn btn-primary" style="size: 50px;">Login Guru</button></a>
          </li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> SD Negeri 10 Semayang All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
